	...
	<div class="container">
		...
		<div class="row">
			<?php
				...
				<div class="col-md-12 item">
					<h4><a href="<?php echo $this->getPermalink($row->cont_slug); ?>"><?php echo $row->cont_titulo ?></a></h4>
		...
		<div class="row">
			...
			$i=0;
				...
				<div class="col-md-4 item">
					...
					<h4><a href="<?php echo  $this->getPermalink($row->cont_slug); ?>"><?php echo $this->getPadre($row->cate_nivel) ?></a></h4>
					<h5><?php echo $row->cont_titulo ?></a></h5>
					<div class="row">
						<div class="col-sm-6" style="padding-right:0">
							<a href="<?php echo  $this->getPermalink($row->cont_slug); ?>"><img src="<?php $src = wp_get_attachment_image_src( $row->cont_idarchivo, 'full');  echo $src[0]; ?>" class="img-fluid"></a>
						</div>
						<div class="col-sm-6">
							<p class="sumilla">
		...
		<div class="row">
			...
			$i=0;
				...
				<!--
				<div class="col-md-2 item">
    				<a href="<?php echo  $this->getPermalink($row->cont_slug); ?>"><img src="<?php echo $row->cont_imagen; ?>" class="img-fluid"></a>
    				<h4><a href="<?php echo  $this->getPermalink($row->cont_slug); ?>"><?php echo $row->cont_titulo ?></a></h4>
    				<h5><?php echo $row->cont_subtitulo ?></a></h5>
    				<a href="#" class="pull-right save"><span class="glyphicon glyphicon-bookmark"></span></a>
    				<div class="stars">
